...
export default function CTASection() {
  return (
    <section className="section-padding bg-navy relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-96 h-96 bg-forest-green/10 rounded-full -translate-y-1/2 translate-x-1/2 blur-3xl" />
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-soft-green/10 rounded-full translate-y-1/2 -translate-x-1/2 blur-3xl" />
      ...
      <div className="container-wide relative z-10 text-center max-w-3xl">
        ...
        >
          {/* Badge */}
          <div className="inline-flex items-center gap-2 bg-forest-green/20 text-soft-green text-sm font-semibold px-4 py-2 rounded-full mb-8 border border-forest-green/30">
          ...
          <h2 className="font-lora text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
            ...
            <span className="text-soft-green">Expired Papers</span> Again
          </h2>
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.98 }}
            className="inline-flex items-center gap-3 bg-forest-green hover:bg-soft-green hover:text-navy text-white font-bold text-xl px-10 py-5 rounded-full transition-colors shadow-2xl shadow-forest-green/30 mb-4"
          >
          ...
          <div className="flex flex-wrap justify-center gap-6">
            {trustBadges.map(({ icon: Icon, label }) => (
              <div key={label} className="flex items-center gap-2 text-white/70">
                <Icon className="w-5 h-5 text-soft-green" />
